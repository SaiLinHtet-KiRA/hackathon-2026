...
const auditLogs = [
  {
    id: "AUD-001",
    timestamp: "2025-12-18 08:42:11",
    operator: "Operator A",
    role: "Admin",
    action: "Dispatched",
    target: "INC-2023-8901",
    before: "—",
    after: "EMS Unit 22 dispatched",
  },
  {
    id: "AUD-002",
    timestamp: "2025-12-18 08:16:45",
    operator: "Operator A",
    role: "Admin",
    action: "Marked False Alarm",
    target: "INC-2023-8906",
    before: "Auto-Detected",
    after: "False Alarm",
  },
  {
    id: "AUD-003",
    timestamp: "2025-12-18 07:55:02",
    operator: "Operator B",
    role: "Operator",
  ...
  {
    id: "AUD-006",
    timestamp: "2025-12-17 21:08:33",
    operator: "Operator C",
    role: "Analyst",
    action: "Exported Report",
    target: "INC-2023-8904",
    before: "—",
    after: "PDF exported",
  },
  {
    id: "AUD-007",
    timestamp: "2025-12-17 18:44:21",
    operator: "Operator B",
    role: "Operator",
    action: "Dispatched",
    target: "INC-2023-8902",
    before: "—",
    after: "Police Unit 5 dispatched",
  },
  {
    id: "AUD-008",
    timestamp: "2025-12-17 16:30:09",
    operator: "Operator A",
    role: "Admin",
    action: "Changed Threshold",
    target: "SMS Threshold",
    before: "55%",
    after: "60%",
  },
  {
    id: "AUD-009",
    timestamp: "2025-12-17 14:15:55",
    operator: "Operator A",
    role: "Admin",
    action: "Edited Camera",
    target: "CAM-W-302",
  ...
  {
    id: "AUD-010",
    timestamp: "2025-12-17 11:03:28",
    operator: "Operator C",
    role: "Analyst",
    action: "Exported Report",
    target: "INC-2023-8903",
    before: "—",
    after: "CSV exported",
  },
  {
    id: "AUD-011",
    timestamp: "2025-12-17 09:22:14",
    operator: "Operator B",
    role: "Operator",
    action: "Marked False Alarm",
    target: "INC-2023-8905",
    before: "Auto-Detected",
    after: "False Alarm",
  },
  {
    id: "AUD-012",
    timestamp: "2025-12-16 20:11:47",
    operator: "Operator A",
    role: "Admin",
    action: "Added User",
    target: "USR-007",
  ...
  {
    id: "AUD-013",
    timestamp: "2025-12-16 15:44:02",
    operator: "Operator A",
    role: "Admin",
    action: "Dispatched",
    target: "INC-2023-8900",
    before: "—",
    after: "Fire Unit 3 dispatched",
  },
  {
    id: "AUD-014",
    timestamp: "2025-12-16 12:30:19",
    operator: "Operator C",
    role: "Analyst",
    action: "Exported Report",
    target: "INC-2023-8899",
    before: "—",
    after: "PDF exported",
  },
  {
    id: "AUD-015",
    timestamp: "2025-12-16 08:05:33",
    operator: "Operator B",
    role: "Operator",
    action: "Edited Camera",
    target: "CAM-S-099",
                  ...
                  return (
                    ...
                    >
                      <td
                        ...
                        style={{ color: "var(--fg2)", fontSize: "11px" }}
                      >
                        {log.timestamp}
                      </td>
                      <td
                      ...
                      <td
                        className="px-4 py-3"
                        style={{ color: "var(--fg)", fontSize: "11px" }}
                      >
                        {log.after}
                      </td>
                    </tr>
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <SectionCard title="AI Detection Configuration" icon={Sliders}>
              ...
              >
                ...
                Fusion (CCTV + SMS). Incidents below {aiThreshold}% threshold
                will be flagged for manual review only.
              </div>
            </SectionCard>
            ...
            <SectionCard title="Notification Preferences" icon={Bell}>
              <Toggle
                ...
                sublabel="Instant push + SMS dispatch"
              />
              <Toggle
                value={notifHigh}
              ...
              <Toggle
                ...
                sublabel="Dashboard notification only"
              />
              <Toggle
                value={notifLow}
              ...
              <Toggle
                ...
                label="New SMS Witness Reports"
                sublabel="Notify when multi-language SMS arrives"
              />
              <Toggle
                value={notifCamera}
                onChange={setNotifCamera}
                label="Camera Offline Alerts"
                sublabel="Alert when a CCTV node goes offline"
              />
              <Toggle
                value={emailReports}
                onChange={setEmailReports}
                label="Email Weekly Reports"
                sublabel="Automated PDF report every Monday 08:00"
              />
            </SectionCard>
            ...
            <SectionCard title="Language Preferences" icon={Globe}>
                      ...
                      style={{
                        backgroundColor:
                          selectedLang === lang.code
                            ...
                            : "var(--subtle)",
                        color:
                          selectedLang === lang.code ? "#3b82f6" : "var(--fg)",
              ...
              >
                <Toggle
                  ...
                  label="Dark Theme"
                  sublabel="DETECT dark interface"
                />
              </div>
            </SectionCard>
            ...
            <SectionCard title="Camera Management Settings" icon={Camera}>
              <div className="space-y-5">
                {[
                  ...
                  {
                    label: "Auto-backup RTSP stream on incident",
                    defaultVal: true,
                  },
                  {
                    label: "Motion pre-buffer (30s before incident)",
                    defaultVal: false,
                  },
                ].map((item, i) => (
                  <CameraToggle
          ...
          <SectionCard title="User Management" icon={Users}>
            <div className="flex justify-between items-center mb-3">
              <p className="text-xs" style={{ color: "var(--fg2)" }}>
                Manage operator access and roles for the DETECT system.
              </p>
              <button
